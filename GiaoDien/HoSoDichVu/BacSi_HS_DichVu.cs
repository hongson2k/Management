...
{
    public partial class BacSi_HS_DichVu : Form
    {
        public BacSi_HS_DichVu()
        {
            InitializeComponent();
        }
        ...
        private void BacSi_HS_DichVu_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            using (OracleConnection conn = DBConnection.GetConnection(username, password))
            {
                ...
                {
                    conn.Open();
                    string sql = "Insert into ADMINBV.HOSODICHVU( MaKhamBenh , NgayGio, MaDichVu) "
                                                         + " values( '" + lb_MaKham.Text
                                                         + "' , to_date('" + txt_NgayGio.Text + "', 'DD-MM-YYYY'), '"
                                                         + lb_MaDV.Text + "')";
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            using (OracleConnection conn = DBConnection.GetConnection(username, password))
            {
                ...
                {
                    conn.Open();
                    string sql = " Update ADMINBV.HOSODICHVU SET MaKhamBenh = '"
                        + lb_MaKham.Text + "', MaDichVu = '"
                        + lb_MaDV.Text
                        + "'  where MaKhamBenh = '" + lb_MaKham.Text + "' and MaDichVu = '" + lb_MaDV.Text + "' and NgayGio = " + "to_date('" + txt_NgayGio.Text + "', 'DD-MM-YYYY')";
